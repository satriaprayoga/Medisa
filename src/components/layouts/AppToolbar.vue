    ...
    <v-toolbar-title class="ml-0 pl-3">
      ...
      <v-spacer></v-spacer>
       <v-menu offset-y origin="center center" class="elelvation-1" :nudge-bottom="14" transition="scale-transition">
        ...
        <v-icon medium>perm_identity</v-icon>
        </v-btn>
        <v-list class="pa-0">
...
export default {
    ...
    methods:{
      toggleDrawer(){
        var toggled=this.$store.getters['layoutsMenusModule/getDrawer'];
        this.$store.dispatch('layoutsMenusModule/toggleDrawer',toggled);
      }
    }
}
</script>
